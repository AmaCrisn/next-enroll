...
export default function Home() {
  return (
    <div className="flex justify-center items-center h-[calc(100vh-178px)]">
      <div className="p-10 bg-(--clr-bg-card) border-2 border-(--clr-border) rounded-3xl shadow-lg">
        ...
        <form className="flex flex-col gap-4 mb-10">
          ...
          <div className="flex items-center justify-between gap-3 px-2 text-sm">
            ...
            <Link href="#" className="hover:underline hover:text-(--clr-primary) active:text-(--clr-primary-active)">Lupa password?</Link>
          </div>
        </form>
